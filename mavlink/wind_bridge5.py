...
def main():
    ...
    # ---- Pipeline Actisense â†’ analyzer (EL QUE TE FUNCIONA) ----
    ...
    try:
        for raw in p2.stdout:
            ...
            # Convertir grados â†’ radianes (NECESARIO para MAVLink)
            wind_angle_rad = math.radians(wind_angle_deg)

            # Barco â†’ componente vertical siempre 0
            speed_z = 0.0
            ...
            logging.info(
                ...
                f"{wind_angle_deg:.1f}Â° | HUD vector = ({wind_x:.2f}, {wind_y:.2f})"
            )
